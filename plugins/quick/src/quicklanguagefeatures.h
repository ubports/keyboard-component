...
class QuickLanguageFeatures : public QObject, public AbstractLanguageFeatures
{
    Q_OBJECT
public:
    explicit QuickLanguageFeatures(QObject *parent = 0);
    virtual ~QuickLanguageFeatures();
