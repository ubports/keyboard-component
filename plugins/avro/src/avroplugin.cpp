...
void AvroPlugin::spellCheckerSuggest(const QString& word, int limit)
{
...
void AvroPlugin::addToSpellCheckerUserWordList(const QString& word)
{
    Q_EMIT addToUserWordList(word);
}

bool AvroPlugin::setLanguage(const QString& languageId, const QString& pluginPath)
{
...
void AvroPlugin::addSpellingOverride(const QString& orig, const QString& overriden)
{
    Q_EMIT addOverride(orig, overriden);
}

void AvroPlugin::loadOverrides(const QString& pluginPath) {
...
void AvroPlugin::spellCheckFinishedProcessing(QString word, QStringList suggestions) {
